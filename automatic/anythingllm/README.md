# AnythingLLM Desktop Chocolatey Package

## Install

```powershell
choco install anythingllm
```
...
```powershell
choco install anythingllm --version=1.15.0
```
...
```powershell
choco upgrade anythingllm
```

## Uninstall

```powershell
choco uninstall anythingllm
```
...
| Chocolatey page | https://community.chocolatey.org/packages/anythingllm |
| Package source | https://github.com/MKAbuMattar/chocolatey-packages/tree/main/automatic/anythingllm |
...
AnythingLLM Desktop itself is distributed under its own [license](https://github.com/Mintplex-Labs/anything-llm/blob/master/LICENSE).
