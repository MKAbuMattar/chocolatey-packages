...
```powershell
choco upgrade dashbeam
```

## Uninstall

```powershell
choco uninstall dashbeam
```
...
Dashbeam itself is distributed under its own [license](https://github.com/tonyantony300/dashbeam/blob/main/LICENSE).
