...
```powershell
choco upgrade himalaya
```

## Uninstall

```powershell
choco uninstall himalaya
```
...
Himalaya itself is distributed under its own [license](https://github.com/pimalaya/himalaya/blob/master/LICENSE-APACHE).
