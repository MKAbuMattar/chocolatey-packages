...
```powershell
choco install jqp --version=<version>
```
...
jqp itself is distributed under its own [license](https://github.com/noahgorstein/jqp/blob/main/LICENSE).
