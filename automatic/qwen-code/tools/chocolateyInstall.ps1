...
$packageArgs = @{
  ...
  url64          = 'https://github.com/QwenLM/qwen-code/releases/download/v0.23.4/qwen-code-win-x64.zip'
  checksum64     = '58ac45c18193fcb19b27917f4d81059be310a09f58d5fe0d4aaaff2bee53222a'
