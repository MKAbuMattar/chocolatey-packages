...
$packageArgs = @{
  ...
  url64          = 'https://github.com/QwenLM/qwen-code/releases/download/v0.24.4/qwen-code-win-x64.zip'
  checksum64     = 'd7851f4dbc23fb6fd8e9ced8d25e17218e5cfad367546965e78c8757da83c941'
