# kubectl-cnpg Chocolatey Package
...
```powershell
choco upgrade kubectl-cnpg
```

## Uninstall

```powershell
choco uninstall kubectl-cnpg
```
...
kubectl-cnpg itself is distributed under its own [license](https://github.com/cloudnative-pg/cloudnative-pg/blob/main/LICENSE).
