# Boring Registry Chocolatey Package
...
```powershell
choco upgrade boring-registry
```

## Uninstall

```powershell
choco uninstall boring-registry
```
...
Boring Registry itself is distributed under its own [license](https://github.com/boring-registry/boring-registry/blob/main/LICENSE).
