...
```powershell
choco install daytona --version=<version>
```
...
```powershell
choco upgrade daytona
```

## Uninstall

```powershell
choco uninstall daytona
```
...
Daytona itself is distributed under its own [license](https://github.com/daytonaio/daytona).
