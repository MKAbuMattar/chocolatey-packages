...
```powershell
choco upgrade ouroboros
```

## Uninstall

```powershell
choco uninstall ouroboros
```
...
Ouroboros itself is distributed under its own [license](https://github.com/Q00/ouroboros/blob/main/LICENSE).
