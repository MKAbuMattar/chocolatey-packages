...
$packageArgs = @{
  ...
  url64          = 'https://github.com/Guepard-Corp/gfs/releases/download/v0.4.0/gfs-windows-x86_64.tar.gz'
  checksum64     = '7a3672bd9d51c931595bc493976a82a1f99229a2aca666f52e6284016ad33dcc'
