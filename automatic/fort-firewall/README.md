# Fort Firewall Chocolatey Package
...
```powershell
choco install fort-firewall --version=<version>
```
...
```powershell
choco upgrade fort-firewall
```

## Uninstall

```powershell
choco uninstall fort-firewall
```
...
Fort Firewall itself is distributed under its own [license](https://github.com/tnodir/fort/blob/master/LICENSE).
